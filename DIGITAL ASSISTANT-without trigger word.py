...
NOTE_STRS = ["make a note","open note","make a note of this","write this down","remember", "remember this", "type this"]
...
WEB_STRS = ["open chrome","open com","search in chrome","search in web","search"]
for words in WEB_STRS:
    if words in text:
        speak("which website would you like to open? ")
        chrome = get_audio()
        #webs = ["youtube","google","facebook"]
        #for w in webs:
         #   if w in chrome:
          #      a = ".com"
           #     openchrome(chrome)
